...
def fun_hist_processing(img):
    #1
    histSize, ranges = [256], [0, 256]  # num-of0buns(32), bin boundaries?
    ...
    cv2.putText(hist_img, '0', (0, histWShape[0]), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (100,0,255))
    cv2.putText(hist_img, str(int(v2)), (0, histWShape[0]*0+12), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (100, 0, 255))
    '''
    # imshow img, hist_img
    cv2.imshow('image-red', img)
    #cv2.imshow('histogram2', hist_img)
    hist_img = draw_histogram(hist2, histWShape)
    cv2.imshow('histogram2', hist_img)
...
def draw_histogram(hist, shape=(200,256)):
    ...
    cv2.flip(hist_img, 0, hist_img)
    cv2.putText(hist_img, '0', (0, shape[0]), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (100, 0, 255))
    cv2.putText(hist_img, str(int(v2)), (0, shape[0]*0+12), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (100, 0, 255))
